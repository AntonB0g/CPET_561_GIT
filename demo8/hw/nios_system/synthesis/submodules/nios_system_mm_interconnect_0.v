...
module nios_system_mm_interconnect_0 (
		...
		output wire [9:0]  RAM_controller_avalon_slave_address,            //              RAM_controller_avalon_slave.address
		output wire        RAM_controller_avalon_slave_write,              //                                         .write
		output wire        RAM_controller_avalon_slave_read,               //                                         .read
		input  wire [15:0] RAM_controller_avalon_slave_readdata,           //                                         .readdata
		output wire [15:0] RAM_controller_avalon_slave_writedata,          //                                         .writedata
		output wire [1:0]  RAM_controller_avalon_slave_byteenable,         //                                         .byteenable
		input  wire        RAM_controller_avalon_slave_waitrequest,        //                                         .waitrequest
		output wire        RAM_controller_avalon_slave_chipselect,         //                                         .chipselect
	...
	wire  [15:0] ram_controller_avalon_slave_agent_m0_readdata;                                      // RAM_controller_avalon_slave_translator:uav_readdata -> RAM_controller_avalon_slave_agent:m0_readdata
	wire         ram_controller_avalon_slave_agent_m0_waitrequest;                                   // RAM_controller_avalon_slave_translator:uav_waitrequest -> RAM_controller_avalon_slave_agent:m0_waitrequest
	wire         ram_controller_avalon_slave_agent_m0_debugaccess;                                   // RAM_controller_avalon_slave_agent:m0_debugaccess -> RAM_controller_avalon_slave_translator:uav_debugaccess
	wire  [16:0] ram_controller_avalon_slave_agent_m0_address;                                       // RAM_controller_avalon_slave_agent:m0_address -> RAM_controller_avalon_slave_translator:uav_address
	wire   [1:0] ram_controller_avalon_slave_agent_m0_byteenable;                                    // RAM_controller_avalon_slave_agent:m0_byteenable -> RAM_controller_avalon_slave_translator:uav_byteenable
	wire         ram_controller_avalon_slave_agent_m0_read;                                          // RAM_controller_avalon_slave_agent:m0_read -> RAM_controller_avalon_slave_translator:uav_read
	wire         ram_controller_avalon_slave_agent_m0_readdatavalid;                                 // RAM_controller_avalon_slave_translator:uav_readdatavalid -> RAM_controller_avalon_slave_agent:m0_readdatavalid
	wire         ram_controller_avalon_slave_agent_m0_lock;                                          // RAM_controller_avalon_slave_agent:m0_lock -> RAM_controller_avalon_slave_translator:uav_lock
	wire  [15:0] ram_controller_avalon_slave_agent_m0_writedata;                                     // RAM_controller_avalon_slave_agent:m0_writedata -> RAM_controller_avalon_slave_translator:uav_writedata
	wire         ram_controller_avalon_slave_agent_m0_write;                                         // RAM_controller_avalon_slave_agent:m0_write -> RAM_controller_avalon_slave_translator:uav_write
	wire   [1:0] ram_controller_avalon_slave_agent_m0_burstcount;                                    // RAM_controller_avalon_slave_agent:m0_burstcount -> RAM_controller_avalon_slave_translator:uav_burstcount
	wire         ram_controller_avalon_slave_agent_rf_source_valid;                                  // RAM_controller_avalon_slave_agent:rf_source_valid -> RAM_controller_avalon_slave_agent_rsp_fifo:in_valid
	wire  [75:0] ram_controller_avalon_slave_agent_rf_source_data;                                   // RAM_controller_avalon_slave_agent:rf_source_data -> RAM_controller_avalon_slave_agent_rsp_fifo:in_data
	wire         ram_controller_avalon_slave_agent_rf_source_ready;                                  // RAM_controller_avalon_slave_agent_rsp_fifo:in_ready -> RAM_controller_avalon_slave_agent:rf_source_ready
	wire         ram_controller_avalon_slave_agent_rf_source_startofpacket;                          // RAM_controller_avalon_slave_agent:rf_source_startofpacket -> RAM_controller_avalon_slave_agent_rsp_fifo:in_startofpacket
	wire         ram_controller_avalon_slave_agent_rf_source_endofpacket;                            // RAM_controller_avalon_slave_agent:rf_source_endofpacket -> RAM_controller_avalon_slave_agent_rsp_fifo:in_endofpacket
	wire         ram_controller_avalon_slave_agent_rsp_fifo_out_valid;                               // RAM_controller_avalon_slave_agent_rsp_fifo:out_valid -> RAM_controller_avalon_slave_agent:rf_sink_valid
	wire  [75:0] ram_controller_avalon_slave_agent_rsp_fifo_out_data;                                // RAM_controller_avalon_slave_agent_rsp_fifo:out_data -> RAM_controller_avalon_slave_agent:rf_sink_data
	wire         ram_controller_avalon_slave_agent_rsp_fifo_out_ready;                               // RAM_controller_avalon_slave_agent:rf_sink_ready -> RAM_controller_avalon_slave_agent_rsp_fifo:out_ready
	wire         ram_controller_avalon_slave_agent_rsp_fifo_out_startofpacket;                       // RAM_controller_avalon_slave_agent_rsp_fifo:out_startofpacket -> RAM_controller_avalon_slave_agent:rf_sink_startofpacket
	wire         ram_controller_avalon_slave_agent_rsp_fifo_out_endofpacket;                         // RAM_controller_avalon_slave_agent_rsp_fifo:out_endofpacket -> RAM_controller_avalon_slave_agent:rf_sink_endofpacket
	...
	wire         ram_controller_avalon_slave_agent_rp_valid;                                         // RAM_controller_avalon_slave_agent:rp_valid -> router_003:sink_valid
	wire  [74:0] ram_controller_avalon_slave_agent_rp_data;                                          // RAM_controller_avalon_slave_agent:rp_data -> router_003:sink_data
	wire         ram_controller_avalon_slave_agent_rp_ready;                                         // router_003:sink_ready -> RAM_controller_avalon_slave_agent:rp_ready
	wire         ram_controller_avalon_slave_agent_rp_startofpacket;                                 // RAM_controller_avalon_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         ram_controller_avalon_slave_agent_rp_endofpacket;                                   // RAM_controller_avalon_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire         ram_controller_avalon_slave_burst_adapter_source0_valid;                            // RAM_controller_avalon_slave_burst_adapter:source0_valid -> RAM_controller_avalon_slave_agent:cp_valid
	wire  [74:0] ram_controller_avalon_slave_burst_adapter_source0_data;                             // RAM_controller_avalon_slave_burst_adapter:source0_data -> RAM_controller_avalon_slave_agent:cp_data
	wire         ram_controller_avalon_slave_burst_adapter_source0_ready;                            // RAM_controller_avalon_slave_agent:cp_ready -> RAM_controller_avalon_slave_burst_adapter:source0_ready
	wire   [5:0] ram_controller_avalon_slave_burst_adapter_source0_channel;                          // RAM_controller_avalon_slave_burst_adapter:source0_channel -> RAM_controller_avalon_slave_agent:cp_channel
	wire         ram_controller_avalon_slave_burst_adapter_source0_startofpacket;                    // RAM_controller_avalon_slave_burst_adapter:source0_startofpacket -> RAM_controller_avalon_slave_agent:cp_startofpacket
	wire         ram_controller_avalon_slave_burst_adapter_source0_endofpacket;                      // RAM_controller_avalon_slave_burst_adapter:source0_endofpacket -> RAM_controller_avalon_slave_agent:cp_endofpacket
	...
	wire         router_003_src_valid;                                                               // router_003:src_valid -> RAM_controller_avalon_slave_rsp_width_adapter:in_valid
	wire  [74:0] router_003_src_data;                                                                // router_003:src_data -> RAM_controller_avalon_slave_rsp_width_adapter:in_data
	wire         router_003_src_ready;                                                               // RAM_controller_avalon_slave_rsp_width_adapter:in_ready -> router_003:src_ready
	wire   [5:0] router_003_src_channel;                                                             // router_003:src_channel -> RAM_controller_avalon_slave_rsp_width_adapter:in_channel
	wire         router_003_src_startofpacket;                                                       // router_003:src_startofpacket -> RAM_controller_avalon_slave_rsp_width_adapter:in_startofpacket
	wire         router_003_src_endofpacket;                                                         // router_003:src_endofpacket -> RAM_controller_avalon_slave_rsp_width_adapter:in_endofpacket
	wire         ram_controller_avalon_slave_rsp_width_adapter_src_valid;                            // RAM_controller_avalon_slave_rsp_width_adapter:out_valid -> rsp_demux_001:sink_valid
	wire  [92:0] ram_controller_avalon_slave_rsp_width_adapter_src_data;                             // RAM_controller_avalon_slave_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire         ram_controller_avalon_slave_rsp_width_adapter_src_ready;                            // rsp_demux_001:sink_ready -> RAM_controller_avalon_slave_rsp_width_adapter:out_ready
	wire   [5:0] ram_controller_avalon_slave_rsp_width_adapter_src_channel;                          // RAM_controller_avalon_slave_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	wire         ram_controller_avalon_slave_rsp_width_adapter_src_startofpacket;                    // RAM_controller_avalon_slave_rsp_width_adapter:out_startofpacket -> rsp_demux_001:sink_startofpacket
	wire         ram_controller_avalon_slave_rsp_width_adapter_src_endofpacket;                      // RAM_controller_avalon_slave_rsp_width_adapter:out_endofpacket -> rsp_demux_001:sink_endofpacket
	wire         cmd_mux_001_src_valid;                                                              // cmd_mux_001:src_valid -> RAM_controller_avalon_slave_cmd_width_adapter:in_valid
	wire  [92:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> RAM_controller_avalon_slave_cmd_width_adapter:in_data
	wire         cmd_mux_001_src_ready;                                                              // RAM_controller_avalon_slave_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire   [5:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> RAM_controller_avalon_slave_cmd_width_adapter:in_channel
	wire         cmd_mux_001_src_startofpacket;                                                      // cmd_mux_001:src_startofpacket -> RAM_controller_avalon_slave_cmd_width_adapter:in_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                        // cmd_mux_001:src_endofpacket -> RAM_controller_avalon_slave_cmd_width_adapter:in_endofpacket
	wire         ram_controller_avalon_slave_cmd_width_adapter_src_valid;                            // RAM_controller_avalon_slave_cmd_width_adapter:out_valid -> RAM_controller_avalon_slave_burst_adapter:sink0_valid
	wire  [74:0] ram_controller_avalon_slave_cmd_width_adapter_src_data;                             // RAM_controller_avalon_slave_cmd_width_adapter:out_data -> RAM_controller_avalon_slave_burst_adapter:sink0_data
	wire         ram_controller_avalon_slave_cmd_width_adapter_src_ready;                            // RAM_controller_avalon_slave_burst_adapter:sink0_ready -> RAM_controller_avalon_slave_cmd_width_adapter:out_ready
	wire   [5:0] ram_controller_avalon_slave_cmd_width_adapter_src_channel;                          // RAM_controller_avalon_slave_cmd_width_adapter:out_channel -> RAM_controller_avalon_slave_burst_adapter:sink0_channel
	wire         ram_controller_avalon_slave_cmd_width_adapter_src_startofpacket;                    // RAM_controller_avalon_slave_cmd_width_adapter:out_startofpacket -> RAM_controller_avalon_slave_burst_adapter:sink0_startofpacket
	wire         ram_controller_avalon_slave_cmd_width_adapter_src_endofpacket;                      // RAM_controller_avalon_slave_cmd_width_adapter:out_endofpacket -> RAM_controller_avalon_slave_burst_adapter:sink0_endofpacket
	...
	wire         ram_controller_avalon_slave_agent_rdata_fifo_src_valid;                             // RAM_controller_avalon_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [17:0] ram_controller_avalon_slave_agent_rdata_fifo_src_data;                              // RAM_controller_avalon_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         ram_controller_avalon_slave_agent_rdata_fifo_src_ready;                             // avalon_st_adapter_001:in_0_ready -> RAM_controller_avalon_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                                  // avalon_st_adapter_001:out_0_valid -> RAM_controller_avalon_slave_agent:rdata_fifo_sink_valid
	wire  [17:0] avalon_st_adapter_001_out_0_data;                                                   // avalon_st_adapter_001:out_0_data -> RAM_controller_avalon_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                                  // RAM_controller_avalon_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                                  // avalon_st_adapter_001:out_0_error -> RAM_controller_avalon_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) ram_controller_avalon_slave_translator (
		.clk                    (clk_0_clk_clk),                                      //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset),     //                    reset.reset
		.uav_address            (ram_controller_avalon_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (ram_controller_avalon_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (ram_controller_avalon_slave_agent_m0_read),          //                         .read
		.uav_write              (ram_controller_avalon_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (ram_controller_avalon_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (ram_controller_avalon_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (ram_controller_avalon_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (ram_controller_avalon_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (ram_controller_avalon_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (ram_controller_avalon_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (ram_controller_avalon_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (RAM_controller_avalon_slave_address),                //      avalon_anti_slave_0.address
		.av_write               (RAM_controller_avalon_slave_write),                  //                         .write
		.av_read                (RAM_controller_avalon_slave_read),                   //                         .read
		.av_readdata            (RAM_controller_avalon_slave_readdata),               //                         .readdata
		.av_writedata           (RAM_controller_avalon_slave_writedata),              //                         .writedata
		.av_byteenable          (RAM_controller_avalon_slave_byteenable),             //                         .byteenable
		.av_waitrequest         (RAM_controller_avalon_slave_waitrequest),            //                         .waitrequest
		.av_chipselect          (RAM_controller_avalon_slave_chipselect),             //                         .chipselect
		.av_begintransfer       (),                                                   //              (terminated)
		.av_beginbursttransfer  (),                                                   //              (terminated)
		.av_burstcount          (),                                                   //              (terminated)
		.av_readdatavalid       (1'b0),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) ram_controller_avalon_slave_agent (
		.clk                     (clk_0_clk_clk),                                                   //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset),                  //       clk_reset.reset
		.m0_address              (ram_controller_avalon_slave_agent_m0_address),                    //              m0.address
		.m0_burstcount           (ram_controller_avalon_slave_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (ram_controller_avalon_slave_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (ram_controller_avalon_slave_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (ram_controller_avalon_slave_agent_m0_lock),                       //                .lock
		.m0_readdata             (ram_controller_avalon_slave_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (ram_controller_avalon_slave_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (ram_controller_avalon_slave_agent_m0_read),                       //                .read
		.m0_waitrequest          (ram_controller_avalon_slave_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (ram_controller_avalon_slave_agent_m0_writedata),                  //                .writedata
		.m0_write                (ram_controller_avalon_slave_agent_m0_write),                      //                .write
		.rp_endofpacket          (ram_controller_avalon_slave_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (ram_controller_avalon_slave_agent_rp_ready),                      //                .ready
		.rp_valid                (ram_controller_avalon_slave_agent_rp_valid),                      //                .valid
		.rp_data                 (ram_controller_avalon_slave_agent_rp_data),                       //                .data
		.rp_startofpacket        (ram_controller_avalon_slave_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (ram_controller_avalon_slave_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (ram_controller_avalon_slave_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (ram_controller_avalon_slave_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (ram_controller_avalon_slave_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (ram_controller_avalon_slave_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (ram_controller_avalon_slave_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (ram_controller_avalon_slave_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (ram_controller_avalon_slave_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (ram_controller_avalon_slave_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (ram_controller_avalon_slave_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (ram_controller_avalon_slave_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (ram_controller_avalon_slave_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (ram_controller_avalon_slave_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (ram_controller_avalon_slave_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (ram_controller_avalon_slave_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (ram_controller_avalon_slave_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                               //                .error
		.rdata_fifo_src_ready    (ram_controller_avalon_slave_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (ram_controller_avalon_slave_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (ram_controller_avalon_slave_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) ram_controller_avalon_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                                //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset),               // clk_reset.reset
		.in_data           (ram_controller_avalon_slave_agent_rf_source_data),             //        in.data
		.in_valid          (ram_controller_avalon_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (ram_controller_avalon_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (ram_controller_avalon_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (ram_controller_avalon_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (ram_controller_avalon_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (ram_controller_avalon_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (ram_controller_avalon_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (ram_controller_avalon_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (ram_controller_avalon_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                        // (terminated)
		.csr_read          (1'b0),                                                         // (terminated)
		.csr_write         (1'b0),                                                         // (terminated)
		.csr_readdata      (),                                                             // (terminated)
	...
	nios_system_mm_interconnect_0_router_003 router_003 (
		.sink_ready         (ram_controller_avalon_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (ram_controller_avalon_slave_agent_rp_valid),         //          .valid
		.sink_data          (ram_controller_avalon_slave_agent_rp_data),          //          .data
		.sink_startofpacket (ram_controller_avalon_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (ram_controller_avalon_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                                      //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
	...
	) ram_controller_avalon_slave_burst_adapter (
		.clk                   (clk_0_clk_clk),                                                   //       cr0.clk
		.reset                 (nios2_gen2_0_reset_reset_bridge_in_reset_reset),                  // cr0_reset.reset
		.sink0_valid           (ram_controller_avalon_slave_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (ram_controller_avalon_slave_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (ram_controller_avalon_slave_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (ram_controller_avalon_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (ram_controller_avalon_slave_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (ram_controller_avalon_slave_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (ram_controller_avalon_slave_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (ram_controller_avalon_slave_burst_adapter_source0_data),          //          .data
		.source0_channel       (ram_controller_avalon_slave_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (ram_controller_avalon_slave_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (ram_controller_avalon_slave_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (ram_controller_avalon_slave_burst_adapter_source0_ready)          //          .ready
	);
	...
	nios_system_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                                   //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset),                  // clk_reset.reset
		.sink_ready         (ram_controller_avalon_slave_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (ram_controller_avalon_slave_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (ram_controller_avalon_slave_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (ram_controller_avalon_slave_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (ram_controller_avalon_slave_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (ram_controller_avalon_slave_rsp_width_adapter_src_valid),         //          .valid
	...
	altera_merlin_width_adapter #(
	...
	) ram_controller_avalon_slave_rsp_width_adapter (
		.clk                  (clk_0_clk_clk),                                                   //       clk.clk
		.reset                (nios2_gen2_0_reset_reset_bridge_in_reset_reset),                  // clk_reset.reset
		...
		.out_endofpacket      (ram_controller_avalon_slave_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (ram_controller_avalon_slave_rsp_width_adapter_src_data),          //          .data
		.out_channel          (ram_controller_avalon_slave_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (ram_controller_avalon_slave_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (ram_controller_avalon_slave_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (ram_controller_avalon_slave_rsp_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) ram_controller_avalon_slave_cmd_width_adapter (
		.clk                  (clk_0_clk_clk),                                                   //       clk.clk
		.reset                (nios2_gen2_0_reset_reset_bridge_in_reset_reset),                  // clk_reset.reset
		...
		.out_endofpacket      (ram_controller_avalon_slave_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (ram_controller_avalon_slave_cmd_width_adapter_src_data),          //          .data
		.out_channel          (ram_controller_avalon_slave_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (ram_controller_avalon_slave_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (ram_controller_avalon_slave_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (ram_controller_avalon_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                           // (terminated)
	);
	...
	nios_system_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                          // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset),         // in_rst_0.reset
		.in_0_data      (ram_controller_avalon_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (ram_controller_avalon_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (ram_controller_avalon_slave_agent_rdata_fifo_src_ready), //         .ready
