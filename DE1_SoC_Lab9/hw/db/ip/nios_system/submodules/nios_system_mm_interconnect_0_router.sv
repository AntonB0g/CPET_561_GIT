...
(
    ...
    localparam PAD7 = log2ceil(64'h4021068 - 64'h4021060); 
    localparam PAD8 = log2ceil(64'h4021070 - 64'h4021068); 
    localparam PAD9 = log2ceil(64'h4021074 - 64'h4021070); 
    // -------------------------------------------------------
    ...
    // ( 0x4021060 .. 0x4021068 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 27'h4021060  && read_transaction  ) begin
            src_channel = 10'b0000010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 8;
    end

    // ( 0x4021068 .. 0x4021070 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 27'h4021068   ) begin
